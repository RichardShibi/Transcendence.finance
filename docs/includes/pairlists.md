...
Alternatively, a strategy can define `pair_whitelist` which takes precedence over the configuration list.
This list is read directly from the strategy at runtime and does not modify the configuration file.
